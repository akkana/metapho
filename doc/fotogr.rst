...
| -t \| taglines: print out the tag lines that match, not just the
  filenames, in case you need to narrow the search \|
...
fotogr can understand simple logical combinations. Each keyword can
specify one of three types of patterns:
...
Copyright (C) 2013-2026 Akkana Peck. Part of Metapho,
which is free software, licensed under the GNU Public License version 2
(or later).
